...
const UZ: Dict = {
  ...
  "date.aria.month": "Oy",
  "date.aria.year": "Yil",
  "date.aria.group": "Sana: kun, oy, yil",
  "date.err.invalid": "Bunday sana mavjud emas",
  "date.err.min": "Sana {min} dan oldin bo'lishi mumkin emas",
  "date.err.max": "Sana {max} dan keyin bo'lishi mumkin emas",
  "common.yes": "Ha",
  "common.no": "Yo'q",
  "common.from": "dan",
  "common.to": "gacha",
  ...
  "hw.field.assignType": "Vazifa turi",
  "hw.assignType.group": "Butun guruhga",
  "hw.assignType.lesson": "Darsga",
  "hw.assignType.individual": "Bitta o'quvchiga",
  "hw.field.lesson": "Dars",
  "hw.field.student": "O'quvchi",
  "hw.field.link": "Havola",
  "hw.field.file": "Fayl",
  "hw.field.filePick": "Faylni tanlang",
  ...
  "sa.settings.subtitle": "GrowBase tizimini sozlash",
...
const RU: Dict = {
  ...
  "date.ph.year": "гггг",
  "date.aria.day": "День",
  "date.aria.month": "Месяц",
  "date.aria.year": "Год",
  "date.aria.group": "Дата: день, месяц, год",
  "date.err.invalid": "Такой даты не существует",
  "date.err.min": "Дата не может быть раньше {min}",
  "date.err.max": "Дата не может быть позже {max}",
  "common.yes": "Да",
  "common.no": "Нет",
  "common.from": "с",
  "common.to": "по",
  ...
  "hw.field.assignType": "Тип задания",
  "hw.assignType.group": "Всей группе",
  "hw.assignType.lesson": "К уроку",
  "hw.assignType.individual": "Одному ученику",
  "hw.field.lesson": "Урок",
  "hw.field.student": "Ученик",
  "hw.field.link": "Ссылка",
  "hw.field.file": "Файл",
  "hw.field.filePick": "Выбрать файл",
  ...
  "sa.settings.subtitle": "Конфигурация системы GrowBase",
