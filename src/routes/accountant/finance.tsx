...
export const Route = createFileRoute("/accountant/finance")({ component: AccountantFinancePage });

function AccountantFinancePage() {
  ...
  const handleReversePayment = (paymentId: string, amount: number) => {
