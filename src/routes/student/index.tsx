              ...
              myGroups.map((group) => {
                ...
                return (
                  <Link
                    key={group.id}
                    to="/student/schedule"
                    className="edu-row flex min-h-11 items-center gap-3 rounded-xl px-2.5 py-2"
                  >
                    <div className="flex size-10 items-center justify-center rounded-xl bg-gradient-primary text-sm font-bold text-primary-foreground">
                      {initialsOf(course?.name ?? group.name)}
                    </div>
                    <div className="min-w-0 flex-1">
                      ...
                      <div
                        ...
                        aria-valuemax={100}
                      >
                        <div className="h-full bg-gradient-primary" style={{ width: `${Math.min(100, progress)}%` }} />
                      </div>
                    </div>
